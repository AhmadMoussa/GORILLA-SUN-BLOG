...
<h2>What are GANs?</h2>
The term 'GAN' is an abbreviation and stands for a type of neural network that was introduced in the 2014 research paper 'Generative Adversarial Networks' by Ian Goodfellow. Their main purpose is that it's capable of replicating a specific types of data when you show it enough examples of it.
