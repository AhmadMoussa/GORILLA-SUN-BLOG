...
I also explored differential growth as a submission for <a href="https://twitter.com/sableRaph">@sableraph</a>'s weekly cretive coding challenge. At the time it felt like a little more than I could chew, but I will reiterate on that sketch very soon. I started participating in Raphaël's (another amazing creative coder) weekly challenge the month before, since it seemed like a super nice way to share and improve my creative coding practice, and challenge myself to learn new things. It has also given me something to look forward to every week. Aside that, Raphaël's discord server (the birbsnest), is an incredibly supportive and inclusive community, I never really use discord, but I do for this one server.
...
I also spun up the processing editor during those times where I couldn't use the p5 web editor, and had to brush up on my Java knowledge, which was actually kind of nice, it wasn't all that difficult to find my way back into the language. The last time I had used it was many years ago during my Bachelor's final project in which I coded a very, very bad android app. Sometimes I look back, and then I'm glad that I have those days behind me :)
...
Many cool things happened in August. I returned to Germany and signed up for a driving school. Getting my license was something way overdue (I'm 90% of the way there now). 

Activity on hicetnunc really skyrocketed, a lot of folks from Ethereum came over to Tezos completely wiping out everything I had up for sale on hicetnunc, especially the interactive sketches and the pieces that I had minted in the early days of HEN (stuff with low OBJKT numbers)

I made a cover of one of <a href="https://twitter.com/beesandbombs">@beesandbombs</a> sketches, which he then retweeted, and really drove a lot of traffic to the blog. I also discovered that embeddable p5 widget, which allowed me to structure my tutorials in a much better way and started that entire "Making of:" series, which should have some more entries next year!
