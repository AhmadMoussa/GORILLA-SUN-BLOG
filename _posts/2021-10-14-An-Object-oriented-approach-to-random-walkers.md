...
thumbtype: vid
thumbnail_path: https://gorillasun.de/assets/images/compressed/randomwalkers.webm
published: true
exclude_rss: true
listed: true
legacy: false
...
Consider the code presented my take on it, which is merely <i>one</i> way to go about this.
